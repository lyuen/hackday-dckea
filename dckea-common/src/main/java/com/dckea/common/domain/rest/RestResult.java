...
public class RestResult<T extends RestEntity> {
	...
	private final DckeaExceptionEntity insiemeExceptionDto;
	...
	private RestResult(final Boolean isSuccessful, 
					   ...
					   final DckeaExceptionEntity insiemeExceptionDto) {
	...
	public DckeaExceptionEntity getError() {
	...
	public static final class RestResultBuilder<T extends RestEntity> {
		...
		private DckeaExceptionEntity insiemeExceptionDto;
		...
		public RestResultBuilder<T> setError(DckeaExceptionEntity insiemeExceptionDto) {
			this.insiemeExceptionDto = insiemeExceptionDto;
